...
let CoreClass$1 = class CoreClass {
    ...
    handleMsg = async (messageCtxInComming) => {
        ...
        // Registro local de mensajes enviados por el cliente
/*         logger = new Console({
            stdout: createWriteStream(`${process.cwd()}/chats/${usuario}.txt`,{flags:'a'}),
        });
        logger.log(`usuario:`, usuario ,'mensaje:',mensaje_entrante.body, 'fecha:' ,mensaje_entrante.fecha,'}'); */
        
        function insertarMensaje(user,mensaje,fechita,timestampi){
            set(ref(db,'chats/'+user+'/'+timestampi+"C"),{
                mensaje:mensaje,
                fecha:fechita,
                origen:'cliente'
            })
        ...
        insertarMensaje(usuario,mensaje_entrante.body,mensaje_entrante.fecha,mensaje_entrante.timestamp)
